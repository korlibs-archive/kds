...
class IntMap2<T> private constructor(private var nbits: Int, private val loadFactor: Double) {
    ...
    private fun grow() {
        val new = IntMap2<T>(nbits + 3, loadFactor)
    ...
    fun contains(key: Int): Boolean = _getKeyIndex(key) >= 0
