...
@PublishedApi internal constructor(private var data: Array<TGen>, val comparator: Comparator<TGen>) : MutableCollection<TGen> {
    ...
    override fun equals(other: Any?): Boolean = other is TGenPriorityQueue<*/*_TGen_*/> && this.size == other.size && (this.data as Array<Any?>).contentEquals((other.data as Array<Any?>), 0, this.size) && this.comparator == other.comparator
...
@PublishedApi internal constructor(private var data: IntArray, val comparator: Comparator<Int>) : MutableCollection<Int> {
    ...
    override fun equals(other: Any?): Boolean = other is IntPriorityQueue && this.data.contentEquals(other.data, 0, size) && this.comparator == other.comparator
    override fun hashCode(): Int = data.contentHashCode(0, size)
}
...
@PublishedApi internal constructor(private var data: DoubleArray, val comparator: Comparator<Double>) : MutableCollection<Double> {
    ...
    override fun equals(other: Any?): Boolean = other is DoublePriorityQueue && this.data.contentEquals(other.data, 0, size) && this.comparator == other.comparator
    override fun hashCode(): Int = data.contentHashCode(0, size)
}
...
@PublishedApi internal constructor(private var data: FloatArray, val comparator: Comparator<Float>) : MutableCollection<Float> {
    ...
    override fun equals(other: Any?): Boolean = other is FloatPriorityQueue && this.data.contentEquals(other.data, 0, size) && this.comparator == other.comparator
    override fun hashCode(): Int = data.contentHashCode(0, size)
}
