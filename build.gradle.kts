...
buildscript {
    ...
    dependencies {
        classpath("com.soywiz.korlibs:easy-kotlin-mpp-gradle-plugin:0.2.0-pre-50") // Kotlin 1.3.50-release-112: https://github.com/korlibs/easy-kotlin-mpp-gradle-plugin
    }
}
